...
void solve(int tc)
{
	...
	//Optimal condition is sending the player with most comfort value first
	//Suppose players are : 1,2,3,4,5,6 
	//then order : 6->5->4->3->2->1
	//Comfort values : 6 + 5 + 5 + 4 + 4
}
int main(){
	start();
	time__("solve"){
