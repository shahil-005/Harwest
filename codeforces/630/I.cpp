...
void solve(int tc)
{
	...
	ll ans1=2*(4*3*poweri(4ll,n-3));
	ll ans2=(n-3)*(4*pow(3,2)*poweri(4ll,n-4));
	
	cout<<ans1+ans2;
	
	//https://jamboard.google.com/d/1vRlxJ_jEtWmd2UFNoYD6GrpqZNP9VCLK1_1Fke_k0_0/viewer?f=0
}
int main(){
	start();
	time__("solve"){
