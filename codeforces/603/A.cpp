...
void solve(int tc)
{
	...
	cout<<sz(v)+max(2*(f2>=1 || f1>=2),(f1>=1));
	
	//if continuous 3 chars of same type, eg 111 -> 101, ans+=2
	//if continuous 2 chars of same type, eg 110 -> 010, ans+=1 or 0110 -> 0101 ans+=1
	//if 2 (continuous 2 chars), eg 10110110 -> 10101010 ans+=2
	//proof : by making cases/AC
	
	
	//Proper proofs:
	//https://codeforces.com/blog/entry/21860?#comment-265657
	//https://codeforces.com/blog/entry/21885?#comment-265726
	
	//dp:
	//https://codeforces.com/blog/entry/21885?#comment-265726
	//https://codeforces.com/blog/entry/21885?#comment-265663
}
int main(){
	start();
	time__("solve"){
